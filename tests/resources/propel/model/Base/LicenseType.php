 ...
 */
abstract class LicenseType implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Serato\\SwsApp\\Test\\Propel\\Model\\Map\\LicenseTypeTableMap';
     ...
     *
     * @return $this|LicenseType The current object, for fluid interface
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Serato\SwsApp\Test\Propel\Model\LicenseType
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Serato\SwsApp\Test\Propel\Model\LicenseType The current object, for fluid interface
     */
    ...
    {
        return (string) $this->exportTo(LicenseTypeTableMap::DEFAULT_STRING_FORMAT);
    }
