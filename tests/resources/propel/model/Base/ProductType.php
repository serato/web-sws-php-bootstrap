 ...
 */
abstract class ProductType implements ActiveRecordInterface, \Stringable
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Serato\\SwsApp\\Test\\Propel\\Model\\Map\\ProductTypeTableMap';
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? $startcol : ProductTypeTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', \Serato\SwsApp\Test\Propel\Model\ProductType::class), 0, $e);
        }
    }
    ...
    {
        return $this->exportTo(ProductTypeTableMap::DEFAULT_STRING_FORMAT);
    }
