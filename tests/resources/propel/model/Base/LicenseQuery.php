...
abstract class LicenseQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = \Serato\SwsApp\Test\Propel\Model\License::class, $modelAlias = null)
    {
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByLicenseTypeId(mixed $licenseTypeId = null, ?string $comparison = null)
    {
