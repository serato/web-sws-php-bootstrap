...
abstract class Product implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Serato\\SwsApp\\Test\\Propel\\Model\\Map\\ProductTableMap';
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Serato\SwsApp\Test\Propel\Model\Product
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Serato\SwsApp\Test\Propel\Model\Product The current object, for fluid interface
     */
