...
/**
 * Base class that represents a row from the 'product_serial_numbers' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Product implements ActiveRecordInterface, \Stringable
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Serato\\SwsApp\\Test\\Propel\\Model\\Map\\ProductTableMap';
    ...
    /**
     * Initializes internal state of Serato\SwsApp\Test\Propel\Model\Base\Product object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [product_type_id] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [product_type_id] column.
     *
    ...
    public function setProductTypeId($v)
    {
        ...
        if ($this->product_type_id !== $v) {
            ...
            $this->modifiedColumns[ProductTableMap::COL_PRODUCT_TYPE_ID] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? $startcol : ProductTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', \Serato\SwsApp\Test\Propel\Model\Product::class), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO product_serial_numbers (%s) VALUES (%s)',
     ...
     * objects.
     *
     * @param object $copyObj An object of \Serato\SwsApp\Test\Propel\Model\Product (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Serato\SwsApp\Test\Propel\Model\Product Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
    ...
    {
        return $this->exportTo(ProductTableMap::DEFAULT_STRING_FORMAT);
    }
