 ...
 */
abstract class License implements ActiveRecordInterface, \Stringable
{
    /**
     * TableMap class name
     *
     * @var string
     */
    public const TABLE_MAP = '\\Serato\\SwsApp\\Test\\Propel\\Model\\Map\\LicenseTableMap';
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? $startcol : LicenseTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', \Serato\SwsApp\Test\Propel\Model\License::class), 0, $e);
        }
    }
    ...
    public function setByPosition(int $pos, mixed $value)
    {
        match ($pos) {
            0 => $this->setId($value),
            1 => $this->setProductId($value),
            2 => $this->setLicenseTypeId($value),
            default => $this,
        }; // switch()
    ...
    {
        return $this->exportTo(LicenseTableMap::DEFAULT_STRING_FORMAT);
    }
