...
/**
 * Base class that represents a query for the `license_types` table.
 *
 * @method     ChildLicenseTypeQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildLicenseTypeQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method     ChildLicenseTypeQuery groupById() Group by the id column
 ...
 *
 * @method     ChildLicenseType|null findOne(?ConnectionInterface $con = null) Return the first ChildLicenseType matching the query
 ...
 *
 * @method     ChildLicenseType|null findOneById(int $id) Return the first ChildLicenseType filtered by the id column
 * @method     ChildLicenseType|null findOneByName(string $name) Return the first ChildLicenseType filtered by the name column
 *
 ...
 *
 * @method     ChildLicenseType requireOneById(int $id) Return the first ChildLicenseType filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 *
 * @method     ChildLicenseType[]|Collection find(?ConnectionInterface $con = null) Return ChildLicenseType objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildLicenseType> find(?ConnectionInterface $con = null) Return ChildLicenseType objects based on current ModelCriteria
 *
 * @method     ChildLicenseType[]|Collection findById(int|array<int> $id) Return ChildLicenseType objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildLicenseType> findById(int|array<int> $id) Return ChildLicenseType objects filtered by the id column
 * @method     ChildLicenseType[]|Collection findByName(string|array<string> $name) Return ChildLicenseType objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildLicenseType> findByName(string|array<string> $name) Return ChildLicenseType objects filtered by the name column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildLicenseType> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class LicenseTypeQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = \Serato\SwsApp\Test\Propel\Model\LicenseType::class, $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, name FROM license_types WHERE id = :p0';
        try {
    ...
    public function filterByPrimaryKey(mixed $key)
    {
        ...
        $this->addUsingAlias(LicenseTypeTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(LicenseTypeTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById(mixed $id = null, ?string $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(LicenseTypeTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(LicenseTypeTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        $this->addUsingAlias(LicenseTypeTableMap::COL_ID, $id, $comparison);
    ...
    public function filterByName($name = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(LicenseTypeTableMap::COL_NAME, $name, $comparison);
    ...
    {
        if ($licenseType) {
            $this->addUsingAlias(LicenseTypeTableMap::COL_ID, $licenseType->getId(), Criteria::NOT_EQUAL);
        }
