 ...
 *
 * @method     ChildLicenseType findOneById(int $id) Return the first ChildLicenseType filtered by the id column
 ...
 * @method     ChildLicenseType[]|ObjectCollection findById(int $id) Return ChildLicenseType objects filtered by the id column
...
abstract class LicenseTypeQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(LicenseTypeTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(LicenseTypeTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(LicenseTypeTableMap::COL_ID, $id, $comparison);
    }
