 ...
 * @method     ChildProduct|null findOneByProductTypeId(int $product_type_id) Return the first ChildProduct filtered by the product_type_id column
 *
 ...
 * @method     ChildProduct[]|Collection findByProductTypeId(int|array<int> $product_type_id) Return ChildProduct objects filtered by the product_type_id column
 * @psalm-method Collection&\Traversable<ChildProduct> findByProductTypeId(int|array<int> $product_type_id) Return ChildProduct objects filtered by the product_type_id column
 *
...
abstract class ProductQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'default', $modelName = \Serato\SwsApp\Test\Propel\Model\Product::class, $modelAlias = null)
    {
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByProductTypeId(mixed $productTypeId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(ProductTableMap::COL_PRODUCT_TYPE_ID, $productTypeId, $comparison);
