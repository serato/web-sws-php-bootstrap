...
class ProductTableMap extends TableMap
{
     ...
     */
    public const TABLE_NAME = 'product_serial_numbers';
     ...
     */
    public const OM_CLASS = '\\Serato\\SwsApp\\Test\\Propel\\Model\\Product';
     ...
     */
    public const COL_ID = 'product_serial_numbers.id';

    /**
     * the column name for the product_type_id field
     */
    public const COL_PRODUCT_TYPE_ID = 'product_serial_numbers.product_type_id';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'ProductTypeId', ],
        self::TYPE_CAMELNAME     => ['id', 'productTypeId', ],
        self::TYPE_COLNAME       => [ProductTableMap::COL_ID, ProductTableMap::COL_PRODUCT_TYPE_ID, ],
        self::TYPE_FIELDNAME     => ['id', 'product_type_id', ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'ProductTypeId' => 1, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'productTypeId' => 1, ],
        self::TYPE_COLNAME       => [ProductTableMap::COL_ID => 0, ProductTableMap::COL_PRODUCT_TYPE_ID => 1, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'product_type_id' => 1, ],
        self::TYPE_NUM           => [0, 1, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'COL_ID' => 'ID',
        'product_serial_numbers.id' => 'ID',
        'ProductTypeId' => 'PRODUCT_TYPE_ID',
        'Product.ProductTypeId' => 'PRODUCT_TYPE_ID',
        'productTypeId' => 'PRODUCT_TYPE_ID',
        'product.productTypeId' => 'PRODUCT_TYPE_ID',
        'ProductTableMap::COL_PRODUCT_TYPE_ID' => 'PRODUCT_TYPE_ID',
        'COL_PRODUCT_TYPE_ID' => 'PRODUCT_TYPE_ID',
        'product_type_id' => 'PRODUCT_TYPE_ID',
        'product_serial_numbers.product_type_id' => 'PRODUCT_TYPE_ID',
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName(\Serato\SwsApp\Test\Propel\Model\Product::class);
        $this->setPackage('');
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(ProductTableMap::COL_PRODUCT_TYPE_ID);
        } else {
            $criteria->removeSelectColumn($alias . '.id');
            $criteria->removeSelectColumn($alias . '.product_type_id');
        }
    }
