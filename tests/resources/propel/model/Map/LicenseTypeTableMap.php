...
class LicenseTypeTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.LicenseTypeTableMap';
     ...
     */
    public const TABLE_NAME = 'license_types';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'LicenseType';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Serato\\SwsApp\\Test\\Propel\\Model\\LicenseType';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'LicenseType';
     ...
     */
    public const COL_ID = 'license_types.id';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'license_types.name';
    ...
    protected static $fieldNames = [
        ...
        self::TYPE_COLNAME       => [LicenseTypeTableMap::COL_ID, LicenseTypeTableMap::COL_NAME, ],
    ...
    protected static $fieldKeys = [
        ...
        self::TYPE_COLNAME       => [LicenseTypeTableMap::COL_ID => 0, LicenseTypeTableMap::COL_NAME => 1, ],
    ...
    protected $normalizedColumnNameMap = [
        ...
        'name' => 'NAME',
        'licenseType.name' => 'NAME',
        'LicenseTypeTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
        'license_types.name' => 'NAME',
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->setClassName(\Serato\SwsApp\Test\Propel\Model\LicenseType::class);
        $this->setPackage('');
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(LicenseTypeTableMap::COL_ID);
            $criteria->removeSelectColumn(LicenseTypeTableMap::COL_NAME);
        } else {
